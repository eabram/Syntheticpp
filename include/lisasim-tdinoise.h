...
class TDInoise : public TDI {
 ...
 public:
    ...
    TDInoise(LISA *mylisa, double stproof = 1.0, double sdproof = 2.5e-48,
	     double stshot = 1.0, double sdshot = 1.8e-37, double stlaser = 1.0, double sdlaser = 1.1e-26);
    ...
    virtual double z(int send, int link, int recv, int ret1, int ret2, int ret3, int ret4, int ret5, int ret6,
...
class TDIaccurate : public TDInoise {
 ...
 TDIaccurate(LISA *mylisa, double *stproof, double *sdproof, double *stshot, double *sdshot, double *stlaser, double *sdlaser)
   : TDInoise(mylisa, stproof, sdproof, stshot, sdshot, stlaser, sdlaser) {};

  ~TDIaccurate() {};
  
  double y(int send, int link, int recv, int ret1, int ret2, int ret3, int ret4, int ret5, int ret6, int ret7, double t);
  double z(int send, int link, int recv, int ret1, int ret2, int ret3, int ret4, int ret5, int ret6,
	   int ret7, int ret8, double t);
};


// added EJB -->
class TDIpointing : public TDInoise {
 public:
 TDIpointing(LISA *mylisa, double *stproof, double *sdproof, double *stshot, double *sdshot, double *stlaser, double *sdlaser)
   : TDInoise(mylisa, stproof, sdproof, stshot, sdshot, stlaser, sdlaser) {};
...
extern double breathinganglenoise(double angle, double t, int interp=1);
